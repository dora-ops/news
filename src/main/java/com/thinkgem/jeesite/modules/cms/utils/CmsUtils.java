...
public class CmsUtils {
	 ...
	 * @return
	 */
	public static int getCommentCount(String contentId)
	{
		Comment comment = new Comment();
		comment.setContentId(contentId);
		return commentService.findList(comment).size();
	}
	 ...
	 * @return
	 */
	public static List<Comment> getComments(String siteId, int number)
	{
		Page<Comment> page = new Page<Comment>(1, number, -1);
		Comment comment = new Comment();
		comment.setDelFlag(Link.DEL_FLAG_NORMAL);
